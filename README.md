...
![Proxmox Login](https://github.com/user-attachments/assets/8fb71f8e-8500-4e19-bf69-d68d8a5a3b59)
...
3. **Access via Run Command**:
   - If the NAS drive is not showing up, open the Run command (Windows key + R).
   - # Turning an Old PC into a NAS Server
...
3. **Access via Run Command**:
   - If the NAS drive is not showing up, open the Run command (Windows key + R).
   - ![image](https://github.com/user-attachments/assets/7197a551-a67a-4baf-b8f1-8a2d2caad46b)

   - Type `\\SPRINTZEALSTORAGE` and press Enter.
   - You should be able to access the storage drive and create a shortcut for easy access.
...
![Admin Panel Access](https://github.com/user-attachments/assets/bccae2b8-4c6a-4679-9d2c-830890af0ff9)

## Creating a User in the OMV Panel

1. Click the `Users` option.

![Users Option](https://github.com/user-attachments/assets/0df44bec-2053-4ec6-90e3-d19487a2592a)

2. Click the `+` option.

![Add User](https://github.com/user-attachments/assets/6739ad0c-31ef-4650-9165-7cd62259b3e3)

3. Input the username and password.

![User Details](https://github.com/user-attachments/assets/5c83d65d-8e8a-42ec-9427-f692a37b54b4)

4. Click the `Apply Changes` button after saving.

![Apply Changes](https://github.com/user-attachments/assets/e83a2d26-bdc2-457c-b536-8cbb34d9d6c6)

## Monitoring Storage Usage

- Navigate to `Storage` to see the usage.

![Storage Usage](https://github.com/user-attachments/assets/8a32b441-cd83-4a07-9ba1-0a575da563fd)

## Using the Server

1. Click `Network`.

![Network](https://github.com/user-attachments/assets/43e8c03f-3e47-4608-891c-dc19f3519457)

2. Select the server name.

![Server Name](https://github.com/user-attachments/assets/ba5d4956-da4e-4b61-bc27-4d74e476d0fd)

3. Enter the username and password.

![Username and Password](https://github.com/user-attachments/assets/22c8de2a-13d8-4424-95a6-c96fa46b64b6)

4. Drag and drop files and folders to transfer and store them on the server.

![Drag and Drop](https://github.com/user-attachments/assets/56087680-eb4f-4dc1-8e72-d52b17f12276)

Now everyone connected to the same router or network can access your files.

![Network Access](https://github.com/user-attachments/assets/47fc2e25-59d7-41e1-b90e-16872cf58e2e)
   - Type `\\SPRINTZEALSTORAGE` and press Enter.
   - You should be able to access the storage drive and create a shortcut for easy access.
...
## Accessing the File Browser on Your Storage Server

To access the file browser on your storage server using a web browser, follow these steps:

1. **Open a Web Browser**:
   - Use a web browser on a device that is connected to the same network as your NAS server.

2. **Enter the URL**:
   - Type the following URL into the address bar of your web browser:
     ```
     https://sprintzealstorage.local:3670/files/

     ```
     ![image](https://github.com/user-attachments/assets/38f9a4e5-4385-4e5f-939f-7258a2d6b180)
...
3. **Log In**:
   - When prompted, enter the login credentials:
     - Username: `admin`
     - Password: `admin`
       ![image](https://github.com/user-attachments/assets/3df3ed9c-6b72-482f-a218-3fc9b63ac6d9)

    
  
       

4. **Access Files and Folders**:
   - Once logged in, you should be able to view and manage the files and folders on your storage server.
